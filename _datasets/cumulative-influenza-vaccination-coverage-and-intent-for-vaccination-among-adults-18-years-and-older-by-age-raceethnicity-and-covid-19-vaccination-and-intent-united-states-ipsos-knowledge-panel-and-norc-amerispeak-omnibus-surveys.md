...
data_source: https://data.cdc.gov/Vaccinations/Cumulative-Influenza-Vaccination-Coverage-and-Inte/6p3a-6xr9/about_data
description: 
...
resources:
  - id: 2293
    url: https://www.datalumos.org/datalumos/project/243710/version/V1/view
    format: PDF, CSV
    status: Finished
    size: 0.0
