...
data_source: https://data.cdc.gov/Vaccinations/Weekly-Cumulative-RSV-Vaccination-Coverage-and-Int/k4cb-dxd7/about_data
description: 
...
resources:
  - id: 2875
    url: https://www.datalumos.org/datalumos/project/242805/version/V1/view
    format: PDF, CSV
    status: Finished
    size: 0.0025
