...
data_source: https://data.cdc.gov/Child-Vaccinations/Weekly-Influenza-Vaccination-Status-and-Intent-for/nsxk-tvbw/about_data
description: 
...
resources:
  - id: 2878
    url: https://www.datalumos.org/datalumos/project/244424/version/V1/view
    format: PDF, CSV
    status: Finished
    size: 0.0014
