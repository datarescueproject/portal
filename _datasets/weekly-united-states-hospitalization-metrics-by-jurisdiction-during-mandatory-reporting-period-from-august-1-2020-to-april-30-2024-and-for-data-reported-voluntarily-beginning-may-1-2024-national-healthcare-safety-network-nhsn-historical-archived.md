...
data_source: https://data.cdc.gov/Public-Health-Surveillance/Weekly-United-States-Hospitalization-Metrics-by-Ju/ype6-idgy/about_data
description: 
...
resources:
  - id: 2583
    url: https://www.datalumos.org/datalumos/project/243444/version/V1/view
    format: PDF, CSV
    status: Finished
    size: 0.0006
